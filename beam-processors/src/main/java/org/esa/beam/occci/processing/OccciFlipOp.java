 ...
 */
@OperatorMetadata(alias = "OC-CCI.flip",
        ...
        version = "0.1")
public class OccciFlipOp extends Operator {
    ...
    public void initialize() throws OperatorException {
        ...
        if (equalsLatLon(topLeftPP, topLeftPP, "tl,tl") ||
            ...
            final int flipType = OccciProductFlipper.FLIP_BOTH;
            try {
                productReader = new OccciProductFlipper(flipType, false);
