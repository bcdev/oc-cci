...
public class QaaCellProcessorTest {
    ...
    @Test
    public void testProcess_MODIS_aph_atot() {
        ...
        // out:     [aph_412, aph_443, aph_488, atot_488, atot_531, atot_547]

        // aph:   [-0.035466618835926056, -0.04170411825180054, 0.03294333815574646]
        ...
        // atot: [0.3258124589920044, 0.18097913265228271, 0.1512765884399414, 0.12253236770629883, 0.12102054804563522]
    ...
    @Test
    public void testProcess_MODIS_adg_bbp() {
        final float[] rrs_in = {0.0020080009f, 0.0030860009f, 0.0030160008f, 0.0031800009f, 0.0030520008f, 0.0012980009f};
        final VectorImpl outVector = new VectorImpl(rrs_in);
    ...
    @Test
    public void testCreateOutputFeatureNames_MERIS_no_bbp() {
    ...
    @Test
    public void testCreateOutputFeatureNames_MODIS_no_aph() {
        final QaaConfig config = new QaaConfig();
